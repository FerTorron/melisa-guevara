    ...
    return (
        <div className="recicladaContainer">
            <div className="leftReciclada">
                ...
                <p>Estas piezas únicas fusionan la elegancia y el compromiso ambiental al transformar objetos y materiales preexistentes en obras de arte. Cada joya cuenta su propia historia, ya que los materiales reciclados pueden provenir de diversas fuentes.</p>
                <a href="#">Descubre Más</a>
            </div>
            <div className="rightReciclada">
                <img src="/img/hilos.png" alt="Hilos" />
            </div>
        </div>
    )
}
