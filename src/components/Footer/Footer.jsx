...
const Footer = () => {
    ...
    const mostrarSocialDiv = () => {

        if (windowWidth < 1150) {
            return <footer id='footer'>
                <div className="topFooter">
                    <img className='disableInResponsive' src="/img/icons/logo.svg" alt="Logo Melisa Guevara" />
                    <div className="contactInfo">
                        <div className="contactText">
                            <span id='contactFooter'>Contáctanos</span>
                            <p id='pContactFooter' className='enableInResponsive'>info@melisaguevara.com</p>
                        </div>
                        <div className='socialContact'>
                            <div className="contactItem disableInResponsive">
                                <a href="mailto:info@melisaguevara.com">
                            ...
                            <div className="contactItem">
                                ...
                                <div className="txtContact">
                                    <span className='disableInResponsive'>Whatsapp</span>
                                    <p className='disableInResponsive'>+5492612472520</p>
                                </div>
                            </div>
